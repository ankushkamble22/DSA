...
int main (void) 
{
	...
	if ( entry == 1) {
		...
		temp_double -> next = head_double;
		head_double -> previous = temp_double;
		temp_double = head_double;
		printf ("\nEnter the choice:\n1.insert_beginning\n2.insert_end\n3.insert_position\n4. insert_before_position\n5. insert_after_position\n6.insert_in_middle\n7. insert_in_penultimate\n8. delete_at_beginning\n9. delete_at_end\n10. delete_at_position\n11. delete_before_position\n12. delete_after_position\n13. delete_at_middle\n14. delete_at_penultimate\n\n");
		printf("Enter:\n");
		scanf ("%d", &choice_4);
		switch ( choice_4 ) {
			case 1:
				circular_double_insert_beginning ( head_double );
				break;
			case 2:
				circular_double_insert_end ( head_double );
				break;
			case 3:
				circular_double_insert_position ( head_double );
				break;
			case 4:
				circular_double_insert_before_position ( head_double );
				break;
			case 5:
				circular_double_insert_after_position ( head_double );
				break;
			case 6:
				circular_double_insert_in_middle ( head_double, store );
				break;
			case 7:
				circular_double_insert_in_penultimate ( head_double, num );
				break;
			case 8:
				circular_double_delete_at_beginning ( head_double );
				break;
			case 9:
				circular_double_delete_at_end ( head_double, num );
				break;
			case 10:
				circular_double_delete_at_position ( head_double, num );
				break;
			case 11:
				circular_double_delete_before_position ( head_double, num );
				break;
			case 12:
				circular_double_delete_after_position ( head_double, num );
				break;
			case 13:
				circular_double_delete_at_middle ( head_double, store );
				break;
			case 14:
				circular_double_delete_at_penultimate ( head_double, num );
				break;
			default:
				printf("Wrong entry!!!!!!\n");
		}
